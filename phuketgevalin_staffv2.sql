...
--
-- Host: localhost:3306
-- Generation Time: Nov 12, 2025 at 03:46 PM
...
--
-- Database: `phuketgevalin_staffv2`
--
...
CREATE TABLE `driver_tracking_tokens` (
  ...
  `completion_type` enum('COMPLETED','NO_SHOW') DEFAULT NULL,
...
CREATE TABLE `driver_vehicle_assignments` (
  ...
  `completed_at` datetime DEFAULT NULL COMMENT 'Timestamp when job was completed',
  `completion_type` enum('COMPLETED','NO_SHOW') DEFAULT NULL,
  `completion_latitude` decimal(10,8) DEFAULT NULL COMMENT 'GPS latitude at completion',
  `completion_longitude` decimal(11,8) DEFAULT NULL COMMENT 'GPS longitude at completion'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci;
